...
SUB PlayWAVTask(PWAV AS PLAYWAVType,SB AS SBType)
  ...
  IF SB.S16 THEN
    ...
    OUT SB.LENPORT,(BUFLEN2\2) AND 255
    OUT SB.LENPORT,(BUFLEN2\512) AND 255
    OUT &HD4, SB.HDMA-4
  ELSE
    OUT &HA,&H4+SB.DMA
    OUT &HC,&H0
    ...
    OUT SB.LENPORT,BUFLEN2 AND 255
    OUT SB.LENPORT,(BUFLEN2\256) AND 255
    OUT &HA,SB.DMA
  END IF
  ...
  IF SB.S16 THEN
    ...
    END IF
    CALL WriteDSP(SB,(BUFLEN2\2) AND 255)
    CALL WriteDSP(SB,(BUFLEN2\512) AND 255)
  ELSE
    ...
    END IF
    CALL WriteDSP(SB,(BUFLEN2) AND 255)
    CALL WriteDSP(SB,(BUFLEN2\256) AND 255)
  END IF
END SUB
