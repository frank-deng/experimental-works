export default{
  ...
  methods:{
    ...
    lookGround(ground,camera,captureDistance=40){
      let captX = this.x + captureDistance * Math.sin(Math.PI/180*this.rotation);
      let captY = this.y - captureDistance * Math.cos(Math.PI/180*this.rotation);
